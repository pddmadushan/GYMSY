...
namespace StandaloneSDKDemo
{
    public class SDKHelper
    {
        ...
        public Boolean IamPrimaryMaching;
        ...
        public SDKHelper()
        {
            this.IamPrimaryMaching = false;
            this.iMachineNumber = 1;
        }

        public SDKHelper(int iMachinNumber)
        {
            this.IamPrimaryMaching = false;
            this.iMachineNumber = iMachinNumber;
        }

        public SDKHelper(bool IamPrimary)
        {
            this.IamPrimaryMaching = IamPrimary;
            this.iMachineNumber = 1;
        }
        ...
        public int sta_ConnectTCP(string ip, string port, string commKey)
        {
            ...
            if (bIsConnected == true)
            {
                ...
                {
                    sta_UnRegRealTime_MC();
                }
                else
                {
                    sta_UnRegRealTime_MC2();
                }
        ...
        public int sta_RegRealTime_MC2()
        {
            if (GetConnectState() == false)
            {
                return -1024;
        ...
        public void sta_UnRegRealTime_MC()
        {
            this.axCZKEM1.OnNewUser -= new zkemkeeper._IZKEMEvents_OnNewUserEventHandler(axCZKEM1_OnNewUser);
            this.axCZKEM1.OnAttTransactionEx -= new zkemkeeper._IZKEMEvents_OnAttTransactionExEventHandler(axCZKEM1_OnAttTransactionEx);
        }
        public void sta_UnRegRealTime_MC2()
        {
            this.axCZKEM1.OnAttTransactionEx -= new zkemkeeper._IZKEMEvents_OnAttTransactionExEventHandler(axCZKEM1_OnAttTransactionEx);
        }
        ...
        {
            DataTable dt_User = new DataTable("dt_User");
            dt_User.Columns.Add("BADGENUMBER", System.Type.GetType("System.String"));
            dt_User.Columns.Add("NAME", System.Type.GetType("System.String"));
            dt_User.Columns.Add("PASSWORD", System.Type.GetType("System.String"));
            dt_User.Columns.Add("privilege", System.Type.GetType("System.Int32"));

            DataRow dr = dt_User.NewRow();
            dr["BADGENUMBER"] = EnrollNumber;
            dr["NAME"] = "";
            dr["PASSWORD"] = "";
            dr["privilege"] = 0;
            dt_User.Rows.Add(dr);
        ...
        void axCZKEM1_OnAttTransactionEx(string EnrollNumber, int IsInValid, int AttState, int VerifyMethod, int Year, int Month, int Day, int Hour, int Minute, int Second, int WorkCode)
        {
            ...
            dt_period.Columns.Add("User_ID", System.Type.GetType("System.String"));
            dt_period.Columns.Add("Verify_Date", System.Type.GetType("System.String"));
            dt_period.Columns.Add("Verify_Type", System.Type.GetType("System.Int32"));
            dt_period.Columns.Add("Verify_State", System.Type.GetType("System.Int32"));
            dt_period.Columns.Add("WorkCode", System.Type.GetType("System.Int32"));

            DataRow dr = dt_period.NewRow();
            dr["User_ID"] = EnrollNumber;
            dr["Verify_Date"] = Year + "-" + Month + "-" + Day + " " + Hour + ":" + Minute + ":" + Second;
            dr["Verify_Type"] = VerifyMethod;
            dr["Verify_State"] = IsInValid;
            dr["WorkCode"] = WorkCode;
            dt_period.Rows.Add(dr);

            SMSDA _clsAtt = new SMSDA();
            _clsAtt.SaveAttLog(dt_period);
        }
        ...
        public int sta_DelUserTmp(string sUserID)
        {
            try
            {
                int idwErrorCode = 0;
                ...
                int fpCout = SaveFingerTemp_2DB_4mPrimary(sUserID);
                ...
                {
                    axCZKEM1.SetStrCardNumber("0");
                    if (axCZKEM1.SSR_SetUserInfo(iMachineNumber, sUserID, strName, "", iPrivilege, false))
                    {
                        idwErrorCode = 1;
                    }
                    else
        ...
        public int sta_InsertFPDatatoDB(string sUserID)
        {
            ...
            {              
                ...
                int fpCout = SaveFingerTemp_2DB_4mPrimary(sUserID);
                int carPW = SaveCardAndPaswordtoDB(sUserID);
                return fpCout + carPW;
            }
            catch
            {
        ...
        public int sta_InsertFPDatatoDB4mSec(string sUserID)
        {
            axCZKEM1.EnableDevice(iMachineNumber, false);
            try
            {
                int fpCout = SaveFingerTemp_2DB_4mSecound(sUserID);
                int carPW = SaveCardAndPaswordtoDB(sUserID);
                return fpCout + carPW;
            }
            catch
        ...
        public DataTable sta_GetUserTmp(string sUserID)
        {
            try
            {
                ...
                dt.Columns.Add("FINGER_INDEX", typeof(int)); 
                dt.Columns.Add("SFPTMPDATA", typeof(string));

                SMSDA _clsAtt = new SMSDA();
                for (idwFingerIndex = 0; idwFingerIndex < 10; idwFingerIndex++)
                {
                    if (axCZKEM1.GetUserTmpExStr(iMachineNumber, sUserID, idwFingerIndex, out iFlag, out sFPTmpData, out iFPTmpLength))
                    {
                        dt.Rows.Add(idwFingerIndex, sFPTmpData);
                    }
                }
                return dt;
            }
        ...
        public String sta_GetCardandPassword(string sUserID)
        {
            try
            {
                string contentCrdPW = "";
                ...
                if (axCZKEM1.SSR_GetUserInfo(iMachineNumber, sUserID, out strName, out strPassword, out iPrivilege, out bEnabled))
                {
                    ...
                    if (strCardno != null && strCardno != "0")
                    {
                        contentCrdPW = "CRD: " + strCardno;
                    }

                    if (strPassword != null && strPassword != "")
                    {
                        contentCrdPW = contentCrdPW + "PW: " + strPassword;
                    }
                }
                return contentCrdPW;
            }
        ...
        public int sta_UpdateFingerFrintFromPrimary(string sUserID)
        {
            axCZKEM1.EnableDevice(iMachineNumber, false);
            try
            {
        ...
        public int SaveFingerTemp_2DB_4mPrimary(string sUserID)
        {
            try
            {
                int foundAuthmethod = 0;
                if (IamPrimaryMaching)
                {
                    int idwFingerIndex = 0;
                    List<Tuple<int, string, int, int>> fpTemplates = new List<Tuple<int, string, int, int>>();
                    for (idwFingerIndex = 0; idwFingerIndex < 10; idwFingerIndex++)
                    {
                        if (axCZKEM1.GetUserTmpExStr(iMachineNumber, sUserID, idwFingerIndex, out int iFlag, out string sFPTmpData, out int iFPTmpLength))
                        {
                            if (!string.IsNullOrWhiteSpace(sFPTmpData))
                            {
                                fpTemplates.Add(Tuple.Create(idwFingerIndex, sFPTmpData, iFlag, iFPTmpLength));
                            }
                        }
                    }
                    SMSDA _clsAtt = new SMSDA();
                    foreach (var tpl in fpTemplates)
                    {
                        _clsAtt.InsertHistoryPf(sUserID, tpl.Item1, tpl.Item2, tpl.Item3, tpl.Item4);
                    }
        ...
        public int SaveFingerTemp_2DB_4mSecound(string sUserID)
        {
            try
            {
                int idwFingerIndex = 0;
        ...
        public int SaveCardAndPaswordtoDB(string sUserID)
        {
            try
            {
                int foundAuthmethod = 0;
                ...
                if (axCZKEM1.SSR_GetUserInfo(iMachineNumber, sUserID, out strName, out strPassword, out iPrivilege, out bEnabled))
                {
                    ...
                    if (!(strCardno == "0" && strPassword == ""))
                    {
                        ...
                        SMSDA _clsAtt = new SMSDA();
                        _clsAtt.UpdateCardPassword(sUserID, strCardno, strPassword);                            
                        foundAuthmethod = 1;
                    }
                }
                return foundAuthmethod;
        ...
        public int sta_SetUserFPInfo(String sUserID, DataSet usersPF)
        {
            if (GetConnectState() == false)
            {
                return -1024;
            ...
            if (usersPF.Tables[0].Rows.Count > 0 || strCardno != "0" || strPassword != "")
            {
                ...
                if (axCZKEM1.BeginBatchUpdate(iMachineNumber, 1))
                {
                    if (!IamPrimaryMaching)
                    {
                        ...
                        string strPassword2 = "";
                        bool bEnabled2 = true;
                        if (!axCZKEM1.SSR_GetUserInfo(iMachineNumber, sEnrollNumber, out strName, out strPassword2, out iPrivilege, out bEnabled2))
                        {
                            axCZKEM1.SSR_SetUserInfo(iMachineNumber, sEnrollNumber, sEnrollNumber, strPassword, 0, true);
                        }
                    }

                    if (usersPF.Tables[0].Rows.Count > 0)
                    {
                        foreach (DataRow rd in usersPF.Tables[0].Rows)
                        {
                            sdwFingerIndex = rd["FINGER_INDEX"].ToString();
                            sFlag = rd["IFLAG"].ToString();
                            sFPTmpData = rd["SFPTMPDATA"].ToString();
                    ...
                    if (strCardno != "0" || strPassword != "")
                    {
                        ...
                        if (axCZKEM1.SSR_SetUserInfo(iMachineNumber, sUserID, sUserID, strPassword, 0, bEnabled))
                        {
                            idwErrorCode = 1;
                        }
                        else
                ...
                if (IamPrimaryMaching)
                {
                    _clsAtt.ActiveFringerPrintDelFlg(sUserID);
                }
                else
                {
                    _clsAtt.ActiveFringerPrintDelFlg2(sUserID);
                }
        ...
        /*
        public int sta_OnlySetUserFPInfo(String sUserID, DataSet usersPF)
        {
            if (GetConnectState() == false)
            {
                return -1024;
            ...
            if (usersPF.Tables[0].Rows.Count > 0)
            {
                ...
                if (axCZKEM1.BeginBatchUpdate(iMachineNumber, 1))
                {
                    foreach (DataRow rd in usersPF.Tables[0].Rows)
                    {
                        ...
                        sFlag = rd["IFLAG"].ToString();
                        sFPTmpData = rd["SFPTMPDATA"].ToString();
                        if (!string.IsNullOrWhiteSpace(sdwFingerIndex) && !string.IsNullOrWhiteSpace(sFlag) && !string.IsNullOrWhiteSpace(sFPTmpData))
                        {
                            bool isValidIndex = int.TryParse(sdwFingerIndex, out idwFingerIndex);
                            bool isValidFlag = int.TryParse(sFlag, out iFlag);
                            if (isValidIndex && isValidFlag)
                            {
                                if (axCZKEM1.SetUserTmpExStr(iMachineNumber, sEnrollNumber, idwFingerIndex, iFlag, sFPTmpData))
                                {
                                    idwErrorCode = 1;
                                }
                                else
        ...
        */
        ...
        public int sta_OnyDelUserTmp(string sUserID)
        {
            try
            {
                int idwErrorCode = 0;
                ...
                if (axCZKEM1.SSR_GetUserInfo(iMachineNumber, sUserID, out strName, out strPassword, out iPrivilege, out bEnabled))
                {
                    ...
                    if (strCardno != "0")
                    {
                        axCZKEM1.SSR_SetUserInfo(iMachineNumber, sUserID, strName, "", iPrivilege, bEnabled);
                    }
                }
                SMSDA _clsAtt = new SMSDA();
                if (IamPrimaryMaching)
                {
                    _clsAtt.InsertFringerPrintDelFlgWithoutSMS(sUserID, strCardno, strPassword);
                }
                else
                {
                    _clsAtt.InsertFringerPrintInactive(sUserID);
        ...
        public int sta_SetUserInfo(string sdwEnrollNumber, string sName,string sPassword, int iPrivilege, bool bEnabled)
        {
            int idwErrorCode = 0;
            iMachineNumber = GetMachineNumber();
            ...
            if (axCZKEM1.SSR_SetUserInfo(iMachineNumber, sdwEnrollNumber, sName, sPassword, iPrivilege, bEnabled))
            {
                ...
                bool result = axCZKEM1.SSR_GetUserInfo(MachineNumber, EnrollNumber, out Name, out Password, out Privilege, out Enabled);
       ...
       public int sta_downloadOneUserPhoto(ListBox lblOutputInfo, string userID, string path)
       {
           ...
           /* --Dinesha if (axCZKEM1.DownloadUserPhoto(GetMachineNumber(), photoName, path))
          {
              ret = 1;
...
*/
        ...
        */
        ...
        private List<string> sta_batchDownloadBioTemplates(System.Windows.Forms.ProgressBar procBar, int aBioType)
        {
            ...
            foreach (Employee e in employeeList)
            {
               ...
               //--Dinesha  int dataCount = axCZKEM1.SSR_GetDeviceDataCount(PersBioTableName, filter, string.Empty);
                int dataCount = 1;
        ...
        public int sta_GetAllBellData(ListBox lblOutputInfo, DataTable dt_allBell)
        {
            ...
            /* --Dinesha if (axCZKEM1.ReadAllBellSchData(GetMachineNumber()))//read all the bell schedual data records to the memory
           {
        ...
        public int sta_setBellInfo(ListBox lblOutputInfo, int weekday, int index, int Enable, int Hour, int min, int voice, int bellway, int inerbelldelay, int extbelldelay)
        {
            ...
            /* --Dinesha  if (axCZKEM1.GetBellSchDataEx(GetMachineNumber(), tmpWeekday, index, out tmpEnable, out tmpHour, out tmpMin, out tmpVoice, out tmpBellway, out tmpInerbelldelay, out tmpExtbelldelay) == false)
            {
            ...
            /* --Dinesha  if (axCZKEM1.SetBellSchDataEx(GetMachineNumber(), weekday, index, Enable, Hour, min, voice, bellway, inerbelldelay, extbelldelay))
            {
        ...
        public int sta_getAllShortkeyFunctionName(ListBox lblOutputInfo, ComboBox cb_stKey, ComboBox cb_function)
        {
            ...
            int funtionBufSize = 1024;
             ...
             /* --Dinesha if (axCZKEM1.GetAllSFIDName(GetMachineNumber(), out shortkeyList, shortkeyBufSize, out functionList, funtionBufSize))
            {
        ...
        public int sta_getShortkeyByID(ListBox lblOutputInfo, int ShortKeyID, ref string ShortKeyName, ref string FunctionName, ref int ShortKeyFun, ref int stateCode, ref string stateName, ref string description, ref int intAutoChange, ref string strAutoChangeTime)
        {
            ...
            /* --Dinesha if (axCZKEM1.GetShortkey(GetMachineNumber(), ShortKeyID, ref ShortKeyName, ref FunctionName, ref ShortKeyFun, ref stateCode, ref stateName, ref description, ref intAutoChange, ref strAutoChangeTime))
           {
       ...
       public int sta_setShortkey(ListBox lblOutputInfo, int ShortKeyID, string ShortKeyName, string FunctionName, int ShortKeyFun, int stateCode, string stateName, string description,  int intAutoChange, string strAutoChangeTime)
       {
           ...
           axCZKEM1.EnableDevice(GetMachineNumber(), false);//disable the device
            ...
            /* --Dinesha if (axCZKEM1.SetShortkey(GetMachineNumber(), ShortKeyID, ShortKeyName, FunctionName, ShortKeyFun, stateCode, stateName, description, intAutoChange, strAutoChangeTime))
           {
        ...
        public int sta_uploadAdvertisePicture(ListBox lblOutputInfo, string pictureFile,string pictureName)
        {
            ...
            axCZKEM1.EnableDevice(GetMachineNumber(), false);//disable the device
             ...
             /* --Dinesha if (axCZKEM1.UploadPicture(GetMachineNumber(), pictureFile, pictureName))
            {
                ret = 1;
        ...
        public int sta_uploadWallpaper(ListBox lblOutputInfo, string pictureFile, string pictureName)
        {
            ...
            /* --Dinesha  if (axCZKEM1.UploadTheme(GetMachineNumber(), pictureFile, pictureName))
            {
                ret = 1;
        ...
        public int sta_GetAllUserInfo_MC()
        {
            ...
            {
                DataRow dr = dt_User.NewRow();
                dr["BADGENUMBER"] = sEnrollNumber;
                dr["NAME"] = sName;
                dr["PASSWORD"] = sPassword;
                dr["privilege"] = iPrivilege;
                dt_User.Rows.Add(dr);
            }
        ...
        public DateTime? getdeviseTime()
        {
            ...
            {
                toTime = new DateTime(idwYear, idwMonth, idwDay, idwHour, idwMinute, idwSecond);                
            }
            else
            {
                axCZKEM1.GetLastError(ref idwErrorCode);
        ...
        public int sta_DeleteLogUptoPreviousDay()
        {
            try
            {
                int ret = 0;
                SMSDA _clsAtt = new SMSDA();
                if (_clsAtt.CanMachineFlush())
                {
        ...
        public int sta_DeleteLogUptoPreviousDay2()
        {
            try
            {
                int ret = 0;
                SMSDA _clsAtt = new SMSDA();
                if (_clsAtt.CanMachineFlush2())
                {
        ...
        */
        ...
        public int sta_DeleteAttLog()
         ...
         public int sta_DeleteAttLogByPeriod(ListBox lblOutputInfo, string fromTime, string toTime)
         {
             ...
             /* --Dinesha  if (axCZKEM1.DeleteAttlogBetweenTheDate(GetMachineNumber(), fromTime, toTime))
             {
                 axCZKEM1.RefreshData(GetMachineNumber());
                 ret = 1;
             }
         ...
         public int sta_DelOldAttLogFromTime(ListBox lblOutputInfo, string fromTime)
         {
             ...
             /* --Dinesha if (axCZKEM1.DeleteAttlogByTime(GetMachineNumber(), fromTime))
            {
                axCZKEM1.RefreshData(GetMachineNumber());
                ret = 1;
            }
        ...
        public int sta_ReadNewAttLog(ListBox lblOutputInfo, DataTable dt_logNew)
        {
            ...
            /* --Dinesha  if (axCZKEM1.ReadNewGLogData(GetMachineNumber()))
            {
                while (axCZKEM1.SSR_GetGeneralLogData(GetMachineNumber(), out sdwEnrollNumber, out idwVerifyMode,
                            out idwInOutMode, out idwYear, out idwMonth, out idwDay, out idwHour, out idwMinute, out idwSecond, ref idwWorkcode))//get records from the memory
                {
        ...
        public int sta_SetDeviceTime(ListBox lblOutputInfo, DateTime date)
        {
            if (GetConnectState() == false)
            {
                lblOutputInfo.Items.Add("*Please connect first!");
